...
| V1-9 | Self-distributed public release on GitHub (PRD 18.2, 20) | MVP release gate (build plan Section 28); F8; D3; D4; V1-8 | **Proposed:** a signed build attached to a GitHub release installs on release Firefox and passes the MVP release gate. | M |
