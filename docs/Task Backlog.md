...
- **E3:** structure captured 2026-09-26 (`live-evidence/13-preferences.md`):
  ...
  the full tag vocabulary, and which levels count as shared for D5. Blocks
  V1-2.
...
3. Evidence captured (E1 to E4, 2026-09-26). V1-5 is built; its live checks
   are items 111 to 115. Next: V1-2 (approved, owner, 2026-09-26). Still need the owner's approval of their proposed
