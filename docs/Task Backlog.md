...
| F7 | Partial | Ignore is not in the conversation's "Optionen" menu; it is "Profil ignorieren" in the profile's three-dot menu, with no `data-e2e` hook (`live-evidence/10-ignore.md`, 2026-09-24). M9 is therefore Path B. The dialog, result and Delete details remain (item 7). |
