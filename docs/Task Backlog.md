...
| V1-3 | Saved Searches: store a search's URL and filter state, replay it in one click (PRD 6.2, 8.2). **Done (2026-09-26):** a "JoyFox saved searches" bar above the member search results saves the page's address under a name and opens it again in one click (`src/content/saved-searches.ts`, `src/search/`); live check: `manual-acceptance.md`, items 108 to 110 | E1 (captured) | **Approved (owner, 2026-09-26, ADR 0016):** a saved search opens the same URL with the same filters. If JoyClub's search address no longer matches, JoyFox says so and opens nothing. | S |
...
1. Done: V1-3, V1-7, V1-8, V1-11 and V1-12. Their live checks are items 101
   and 102 (V1-7), 103 and 104 (V1-12), 105 to 107 (V1-11) and 108 to 110
   (V1-3).
2. Deferred to the future roadmap: V1-6 (and D2).
3. Evidence captured (E1 to E4, 2026-09-26); each needs the owner's approval
   of its proposed criteria: V1-4, V1-2, V1-5, V1-10, then V1-13 (after V1-5).
